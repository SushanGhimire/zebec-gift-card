...
const SendCrypto = () => {
  return (
    <div className="web-padding py-[40px]">
      ...
      <div className="md:flex gap-6 lg:gap-10 mt-10 items-center">
        ...
        <div className="bg-zebec-teal p-6 lg:px-14 lg:py-16 rounded-[10px] flex-1 bg-opacity-[0.18] sm:flex space-y-10 sm:space-y-0 gap-6">
                ...
                {items.map((data) => {
                  return (
                    <div key={data.title} className="max-w-[19rem]">
                      ...
                      <p className="text-sm lg:text-xl text-grey-dark">
                        {data.desc}
                      </p>
                    </div>
                  );
